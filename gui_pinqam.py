...
#
# Created: Sat Aug 16 20:01:22 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_12.setGeometry(QtCore.QRect(20, 10, 231, 221))
        ...
        self.btnStart_2.setGeometry(QtCore.QRect(20, 240, 83, 24))
        self.btnStart_2.setObjectName(_fromUtf8("btnStart_2"))
        self.btnClose_6 = QtGui.QPushButton(self.tab_5)
        self.btnClose_6.setGeometry(QtCore.QRect(120, 240, 83, 24))
        ...
        self.menuWei_abgleich = QtGui.QMenu(self.menuEinstellungen)
        self.menuWei_abgleich.setObjectName(_fromUtf8("menuWei_abgleich"))
        ...
        self.menuWei_abgleich.addAction(self.actionOff)
        self.menuWei_abgleich.addAction(self.actionAuto)
        self.menuWei_abgleich.addAction(self.actionSunlight)
        self.menuWei_abgleich.addAction(self.actionCloudy)
        self.menuWei_abgleich.addAction(self.actionShade)
        self.menuWei_abgleich.addAction(self.actionTungsten)
        self.menuWei_abgleich.addAction(self.actionIncandescent)
        self.menuWei_abgleich.addAction(self.actionFlash)
        ...
        self.menuEinstellungen.addAction(self.menuWei_abgleich.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuWei_abgleich.setTitle(QtGui.QApplication.translate("MainWindow", "Weißabgleich", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionAuto.setText(QtGui.QApplication.translate("MainWindow", "automatisch", None, QtGui.QApplication.UnicodeUTF8))
