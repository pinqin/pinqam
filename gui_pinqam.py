...
#
# Created: Sun Mar 15 15:34:46 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSunlight = QtGui.QAction(MainWindow)
        self.actionSunlight.setObjectName(_fromUtf8("actionSunlight"))
        self.actionCloudy = QtGui.QAction(MainWindow)
        self.actionCloudy.setObjectName(_fromUtf8("actionCloudy"))
        self.actionShade = QtGui.QAction(MainWindow)
        self.actionShade.setObjectName(_fromUtf8("actionShade"))
        self.actionTungsten = QtGui.QAction(MainWindow)
        self.actionTungsten.setObjectName(_fromUtf8("actionTungsten"))
        self.actionIncandescent = QtGui.QAction(MainWindow)
        self.actionIncandescent.setObjectName(_fromUtf8("actionIncandescent"))
        self.actionFlash = QtGui.QAction(MainWindow)
        self.actionFlash.setObjectName(_fromUtf8("actionFlash"))
        ...
        self.menuWeis_abgleich.addAction(self.actionOff)
        self.menuWeis_abgleich.addAction(self.actionAuto)
        self.menuWeis_abgleich.addAction(self.actionSunlight)
        self.menuWeis_abgleich.addAction(self.actionCloudy)
        self.menuWeis_abgleich.addAction(self.actionShade)
        self.menuWeis_abgleich.addAction(self.actionTungsten)
        self.menuWeis_abgleich.addAction(self.actionIncandescent)
        self.menuWeis_abgleich.addAction(self.actionFlash)
        ...
        self.menuEinstellungen.addAction(self.menuWeis_abgleich.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuWeis_abgleich.setTitle(QtGui.QApplication.translate("MainWindow", "Weisßabgleich", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionOff.setText(QtGui.QApplication.translate("MainWindow", "aus", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAuto.setText(QtGui.QApplication.translate("MainWindow", "automatish", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSunlight.setText(QtGui.QApplication.translate("MainWindow", "Sonnenlicht", None, QtGui.QApplication.UnicodeUTF8))
        self.actionCloudy.setText(QtGui.QApplication.translate("MainWindow", "bewölkt", None, QtGui.QApplication.UnicodeUTF8))
        self.actionShade.setText(QtGui.QApplication.translate("MainWindow", "Schatten", None, QtGui.QApplication.UnicodeUTF8))
        self.actionTungsten.setText(QtGui.QApplication.translate("MainWindow", "Glühlampe", None, QtGui.QApplication.UnicodeUTF8))
        self.actionIncandescent.setText(QtGui.QApplication.translate("MainWindow", "Leuchtstoffröhre", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFlash.setText(QtGui.QApplication.translate("MainWindow", "Blitz", None, QtGui.QApplication.UnicodeUTF8))
